export const css = {
  ...
  item: {
    ...
    inRange:
      'range bg-gradient-to-t from-indigo-50 to-white text-indigo-800 border-y border-indigo-200',
    startRange:
    ...
    selected: 'bg-gradient-to-t from-indigo-500 to-indigo-400 text-white',
  },
  day: {
    base: 'relative w-[1.6875rem] h-[1.6875rem] inline-flex items-center rounded-full justify-center ring-offset-white focus-visible:relative focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-300 focus-visible:ring-offset-2',
    default: 'hover:bg-gradient-to-t hover:from-indigo-100 hover:to-indigo-50',
    today: 'bg-gradient-to-t from-indigo-100 to-indigo-50 text-indigo-600',
    inRange: 'text-[inherit]',
    selected: 'bg-gradient-to-t from-indigo-600 to-indigo-500 text-white',
  },
  week: {
